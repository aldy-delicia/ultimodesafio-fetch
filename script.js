...
function agregarProductosBase(producto){
    ...
    if (duplicado.length ===1){
        mostrarMensaje("Este producto ya fue cargado,ingrese otro nombre!!");
    }else{
...
function mostrarMensaje(mensaje, claseBT){
    ...
    div.className= 'alert alert-' +claseBT+ ' mt-2';        
...
function borrarProducto(e){
    ...
    if (duplicado.length ===1){
        ...
        mostrarMensaje("eliminado de la base");
        document.getElementById("form-productos").reset();
...
fetch(url)
  ...
  .catch(err=> mostrarMensaje("Error"))